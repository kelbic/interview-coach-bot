...
{{"score": <0-100>, "feedback": "<{detail_level} фидбек от коуча: 1) что хорошо или что было в ответе, 2) что конкретно добавить/улучшить с примером, 3) короткая мотивирующая фраза>", "ideal_answer": "<2-3 ключевых тезиса которые стоило упомянуть>"}}

Правила: тон поддерживающий как ментор, не судья. Даже слабый ответ — начни с того что есть, потом помоги улучшить."""
