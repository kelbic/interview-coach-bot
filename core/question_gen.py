...
Позиция: {grade} {role}
Вопрос: {question}
Ответ кандидата: {answer_trimmed}

Верни ТОЛЬКО JSON (без markdown, без текста до или после):
{{"score": <целое число 0-100>, "feedback": "<разбор до 80 слов: что раскрыто, чего не хватает, как улучшить с мини-примером. Тон ментора. Не начинай с Хорошо/Отлично/Молодец>", "ideal_answer": "<2-3 тезиса до 30 слов>"}}
